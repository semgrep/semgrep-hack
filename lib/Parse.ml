  ...
  Some (
    Alt [|
      Seq [
        ...
        Alt [|
          Token (Name "string");
          Token (Name "xhp_braced_expression");
        |];
      ];
      Alt [|
        Token (Name "xhp_braced_expression");
...
let trans_xhp_close ((kind, body) : mt) : CST.xhp_close =
  ...
  | Children v ->
      ...
      | Seq [v0; v1; v2] ->
          (
            Run.trans_token (Run.matcher_token v0),
            trans_xhp_identifier (Run.matcher_token v1),
...
let trans_keyword ((kind, body) : mt) : CST.keyword =
  match body with
  | Children v ->
      (match v with
      | Alt (0, v) ->
  ...
  | Children v ->
      ...
      | Seq [v0; v1] ->
          (
            ...
            | Alt (1, v) ->
                `Kw (
                  trans_keyword (Run.matcher_token v)
                )
            | _ -> assert false
            )
            ,
      ...
      | Seq [v0; v1; v2; v3; v4; v5; v6; v7; v8; v9] ->
          (
            ...
            Run.opt
              ...
              v8
            ,
            trans_member_declarations (Run.matcher_token v9)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false
      ...
      | Seq [v0; v1; v2; v3] ->
          (
            ...
            Run.repeat
              ...
              v2
            ,
            trans_heredoc_end (Run.matcher_token v3)
          )
      | _ -> assert false
      )
  | Leaf _ -> assert false
          ...
          `Xhp_id_EQ_choice_str (
            ...
            | Seq [v0; v1; v2] ->
                (
                  ...
                  | Alt (1, v) ->
                      `Xhp_braced_exp (
                        trans_xhp_braced_expression (Run.matcher_token v)
                      )
                  | _ -> assert false
                  )
                )
...
and trans_xhp_braced_expression ((kind, body) : mt) : CST.xhp_braced_expression =
  match body with
  | Children v ->
      (match v with
      | Seq [v0; v1; v2] ->
...
let parse_input_tree input_tree =
  ...
  let opt_program = Option.map trans_script matched_tree in
