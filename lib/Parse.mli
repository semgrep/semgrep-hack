...
(**
    Functions for parsing hack programs into a CST.

    Generated by ocaml-tree-sitter.
*)

(** Parse a hack program from a string into a typed OCaml CST.
...
val string :
  ...
  (CST.script, CST.extra) Tree_sitter_run.Parsing_result.t

(** Parse a hack program from a file into a typed OCaml CST.
